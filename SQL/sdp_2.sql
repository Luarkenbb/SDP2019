...
(1, 1, NULL, 'hong kong', '2019-05-02 00:00:00', NULL, 1, 0),
(2, 2, 'vtc23333', '', '2019-06-11 02:25:09', NULL, 1, NULL);
...
(1, 1, 'AA00001', 100, 5000.00, 'packing', 100, NULL),
(2, 2, 'AA00001', 1, 5000.00, 'awaiting', NULL, NULL);
...
--
ALTER TABLE `orderlist`
  MODIFY `orderSerial` int(7) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- 使用資料表 AUTO_INCREMENT `orderspare`
--
ALTER TABLE `orderspare`
  MODIFY `orderSpareID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
