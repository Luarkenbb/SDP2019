...
(11, 2, 'vtc23333', '', '2019-06-13 21:00:55', '2019-06-27 17:16:34', 1, 1),
(12, 2, 'vtc23333', '', '2019-06-28 15:16:27', '2019-06-28 15:17:22', 1, 1);
...
(19, 11, 'AA00002', 550, 400.00, 'packaged', 510),
(20, 12, 'AA00001', 5, 5000.00, 'packaged', 5),
(21, 12, 'AA00003', 25, 30.00, 'packaged', 25);
...
('AA00001', 945, 50, 'screw001', 5000.00),
('AA00002', 0, 50, 'screw002', 400.00),
('AA00003', 775, 500, 'Toy(Big Big ship)', 30.00);
...
(3, 19, 40, 'awaiting', '2019-06-27 17:16:31', NULL);
...
(1, 'MoC8yU7TqCjbo9FxVlEYiQ==', 'Ming', 'staff', 1),
(2, 'MoC8yU7TqCjbo9FxVlEYiQ==', 'Martin', 'admin', 1),
(3, 'MoC8yU7TqCjbo9FxVlEYiQ==', '20', 'storeman', 2),
(5, 'MoC8yU7TqCjbo9FxVlEYiQ==', '2', 'admin', 2);
...
--
-- 使用資料表 AUTO_INCREMENT `dealer`
--
ALTER TABLE `dealer`
  MODIFY `dealerID` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
-- 使用資料表 AUTO_INCREMENT `orderlist`
--
ALTER TABLE `orderlist`
  MODIFY `orderSerial` int(7) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
--
-- 使用資料表 AUTO_INCREMENT `orderspare`
--
ALTER TABLE `orderspare`
  MODIFY `orderSpareID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
--
-- 使用資料表 AUTO_INCREMENT `reorder`
--
ALTER TABLE `reorder`
  MODIFY `reOrderID` int(7) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
--
-- 使用資料表 AUTO_INCREMENT `tofolloworderspare`
--
ALTER TABLE `tofolloworderspare`
  MODIFY `followOrderID` int(7) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
-- 使用資料表 AUTO_INCREMENT `user`
--
ALTER TABLE `user`
  MODIFY `logonID` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
