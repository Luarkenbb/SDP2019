...
(1, 1, '', 'hong kong', '2019-05-02 00:00:00', NULL, 1, 0),
...
(1, 1, 'AA00001', 100, 5000.00, 'packaged', 100, NULL),
(3, 3, 'AA00001', 1, 5000.00, 'awaiting', NULL, NULL),
(4, 3, 'AA00002', 6, 400.00, 'awaiting', NULL, NULL),
(10, 2, 'AA00002', 1200, 400.00, 'packaged', 750, NULL),
(12, 4, 'AA00001', 1, 5000.00, 'awaiting', NULL, NULL);
...
INSERT INTO `tofolloworderspare` (`followOrderID`, `orderSpareID`, `quantity`, `status`, `createdDate`) VALUES
(2, '10', 450, 'awaiting', '2019-06-13 16:20:20');
...
--
ALTER TABLE `orderlist`
  MODIFY `orderSerial` int(7) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
-- 使用資料表 AUTO_INCREMENT `orderspare`
--
ALTER TABLE `orderspare`
  MODIFY `orderSpareID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
--
